#include<Memoria.h>
/*==================================================================*/
/* INIT_MEM : inicia a estrutura basica da memodira                 */
/* ---------------------------------------------------------------- */
...
/* ---------------------------------------------------------------- */
/*==================================================================*/
void init_mem(Memoria *m, bool iws)
{
   long int i;
...
/*===================================================================*/
/* FINALIZE_MEN: finaliza o memoria                                  */
/* ----------------------------------------------------------------- */
/* Parametro de entrada:                                             */
/* ----------------------------------------------------------------- */
/* ----------------------------------------------------------------- */
...
/* ----------------------------------------------------------------- */
/*===================================================================*/
void finalize_mem(Memoria *m, bool iws)
{
  if(iws)
...
/*===================================================================*/
/* SETNAMEPONT: guarda o nome do vetor e testa se ele já foi alocado */
/* ------------------------------------------------------------------*/
/* Parametro de entrada:                                             */
/* ------------------------------------------------------------------*/
/* m     -> estrutura de dados da memoria                            */
...
/* ------------------------------------------------------------------*/
/*===================================================================*/
void setnamepont(Memoria *m,char *s,bool iws){
  int i;
  i=strlen(s);
  if(i>MNOMEPONTEIRO){
...
/*===================================================================*/
/* LOCATENAMEPONT : localiza o vetor pelo nome                       */
/* ------------------------------------------------------------------*/
/* Parametro de entrada:                                             */
/* ------------------------------------------------------------------*/
/* m   -  estrutura de dados da memoria                              */
...
/* ------------------------------------------------------------------*/
/*===================================================================*/
int locatenamepont(Memoria *m,char *s,bool iws){
  int i;
...
/*localizar vetor*/
  if((pt=locatenamepont(m,s,iws))<0)
    exit(EXIT_FAILURE);
...
/*===================================================================*/
/* MOVEVOCTOR : move um vetor na memoria princiapal                  */
/* ------------------------------------------------------------------*/
/* Parametro de entrada:                                             */
/* ------------------------------------------------------------------*/
/* m   -  estrutura de dados da memoria                              */
...
/*... lacalizando vetor*/
   if((pt=locatenamepont(m,name,iws))<0)
      exit(0);
/*...................................................................*/      
   ipont = m->pont[pt][0];
   return &(m->ia[ipont]);
...
/*===================================================================*/
/*===================================================================*/
/* MAPVETOR : map atual de vetores alocados                          */
/* ------------------------------------------------------------------*/
/* Parametro de entrada:                                             */
/* ------------------------------------------------------------------*/
/* m   -  estrutura de dados da memoria                              */
...
/*===================================================================*/
/* CLENAMEPONT : limpa o nome do vetor                               */
/* ------------------------------------------------------------------*/
/* Parametro de entrada:                                             */
/* ------------------------------------------------------------------*/
/* m    - estrutura de dados da memoria                              */
...
/* ------------------------------------------------------------------*/
/*===================================================================*/
void cleannamepont(Memoria *m,int pont){
    strcpy(m->nome_ponteiro[pont]," ");
}
/*===================================================================*/

/*===================================================================*/
/* USO_MEMORIA : Uso da memoria do ia                                */
/* ------------------------------------------------------------------*/
/* Parametro de entrada:                                             */
/* ------------------------------------------------------------------*/
/* m    - estrutura de dados da memoria                              */
...
/* ------------------------------------------------------------------*/
/*===================================================================*/
long uso_memoria(Memoria *m,char *s){
  double conv;
...
/*===================================================================*/
/* USO_MEMORIA : Memoria total disponivel                            */
/* ------------------------------------------------------------------*/
/* Parametro de entrada:                                             */
/* ------------------------------------------------------------------*/
/* m    - estrutura de dados da memoria                              */
...
/*===================================================================*/
/* USO_MEMORIA : Memoria de um determinado vetor                     */
/* ------------------------------------------------------------------*/
/* Parametro de entrada:                                             */
/* ------------------------------------------------------------------*/
/* m    - estrutura de dados da memoria                              */
...
double memoriavector(Memoria *m,char* s,char*npont,bool iws){
  ...
  int tp;
  double np,conv;
  if((tp=locatenamepont(m,npont,iws)) < 0)
    exit(0);
